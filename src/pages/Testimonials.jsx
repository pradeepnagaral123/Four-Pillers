...
const testimonials = [
  ...
  { stars: 5, quote: 'We hired Four Pillers Interiors for our retail space and the result exceeded our expectations. The design perfectly captures our brand essence and has increased footfall.', name: 'Vikram Joshi', role: 'Retail Entrepreneur', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80' },
  ...
  { stars: 5, quote: 'Exceptional service and unmatched creativity. Four Pillers Interiors turned our dated office into a modern, inspiring workspace. Highly recommended!', name: 'Neha Gupta', role: 'Managing Director', img: 'https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?auto=format&fit=crop&w=150&q=80' },
]
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">Hear from our clients about their experience working with Four Pillers Interiors.</p>
          </div>
